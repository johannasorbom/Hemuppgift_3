...
The price per $ m^2 $ for solar cells is $ 1 kr/kWh $ and every $ 1 kW $ solar cells produce $ 1000 kWh/year $. This gives a maximum yearly income of, 
\begin{equation}
I = 195 \cdot 10^6 \cdot 1 = 195 000 000 kr
\end{equation}
...
\mysubpart{Profit}
Adding all of these incomes gives a total income of $ 1.316 kr/kWh $. This means a profit of, 
\begin{eqnarray}
Profit&=& Income - cost \\
&=& 1.316 - 1 \\
&=& 0.316 kr/kWh}
...
\mypart{C}{Is it viable to build a parallel power line to be able to increase the number of solar cells?}
