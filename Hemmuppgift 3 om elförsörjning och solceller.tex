...
Running the excell file with the new values gives a new voltage and y finding where the voltage is no longer in the range 63-77 a new maximum area of solar cells can be calculated. \\

CALCULATIONS\\

The cost of these solar cells are $ 1 kr/kWh $ and the income is 
